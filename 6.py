...
def main(page: ft.Page):
    # 设置全局字体 - 解决字体显示问题
    page.theme = ft.Theme(
        font_family="Microsoft YaHei"  # 使用微软雅黑字体，Windows系统常规中文字体
    )
    ...
    app_bar = ft.Container(
        content=ft.Column([
            ft.Row([
                ft.Text("JGJ59-2011建筑施工安全智能评分系统", size=20, weight=ft.FontWeight.BOLD, color="white"),
                ft.IconButton(
                    icon="info",
                    icon_color="white",
                    tooltip="使用说明",
